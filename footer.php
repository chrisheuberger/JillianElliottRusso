			...
			<div class="col-md-12">
				...
				<footer class="site-footer" id="colophon">
					...
					<div class="site-info">
						...
						<p>&copy; <?php echo date('Y'); ?> Jillian Russo Curatorial Consulting, LLC<br class="footer-mobile-break"><span class="footer-desktop-divider"> &nbsp;&nbsp;|&nbsp;&nbsp; </span>Site by Jillian's husband, <a href="https://www.chrisheuberger.com/">Chris</a>.</p>
