      ...
      (g.version = '2.1.1'),
        ...
        (l.render = function (a, b, d) {
            ...
            (a >= q - h && a >= 0
              ? ((p._totalTime = q),
                ...
                0 === u &&
                  ...
                  (0 > v || (0 >= a && a >= -h) || (v === h && 'isPause' !== p.data)) &&
                    v !== a &&
              ...
              ? ((p._totalTime = p._time = p._cycle = 0),
                ...
                a > -h
                  ...
                  : 0 > a &&
                    ...
                    0 === u &&
                      (p._initted || !p.vars.lazy || d) &&
                      (v >= 0 && (d = !0), (p._rawPrevTime = n = !b || a || v === a ? a : h))),
                p._initted || (d = !0))
          ...
          if (!p._initted) {
            ...
            !p._time || e || o
              ? e && this._ease._calcEnd && !o && (p.ratio = p._ease.getRatio(0 === p._time ? 0 : 1))
        ...
        (g.fromTo = function (a, b, c, d) {
          return (
            (d.startAt = c), (d.immediateRender = 0 != d.immediateRender && 0 != c.immediateRender), new g(a, b, d)
          );
        }),
        (g.staggerTo = g.allTo =
          function (a, b, h, i, l, n, o) {
            var p,
              ...
              w = (h.startAt || m).cycle;
            for (
              k(a) || ('string' == typeof a && (a = c.selector(a) || a), j(a) && (a = d(a))),
                a = a || [],
                p = a.length - 1,
                r = 0;
              p >= r;
        ...
        (g.staggerFrom = g.allFrom =
          function (a, b, c, d, e, f, h) {
            return (
              (c.runBackwards = !0), (c.immediateRender = 0 != c.immediateRender), g.staggerTo(a, b, c, d, e, f, h)
            );
          }),
          ...
          (s.add = function (e, f, g, h) {
            ...
            if (
              ...
              (e._time || (!e._duration && e._initted)) &&
                ...
                (!e._duration || Math.abs(Math.max(0, Math.min(e.totalDuration(), j))) - e._totalTime > 1e-5) &&
                  e.render(j, !1, !1)),
              ...
              if (
                ...
                for (d = o._first; d && ((g = d._next), m === o._time && (!o._paused || t)); )
                  (d._active || (d._startTime <= m && !d._paused && !d._gc)) &&
                    ...
                    d._reversed
                      ? d.render(
                          (d._dirty ? d.totalDuration() : d._totalDuration) - (a - d._startTime) * d._timeScale,
                          b,
                          c
                        )
                ...
                h &&
                  (o._gc ||
                    ((r === o._startTime || s !== o._timeScale) &&
                      ...
                      (f && (j.length && k(), o._timeline.autoRemoveChildren && o._enabled(!1, !1), (o._active = !1)),
              ...
              j &&
                (p._locked ||
                  ...
                  ((u === p._startTime || v !== p._timeScale) &&
                    ...
                    (f && (g.length && h(), p._timeline.autoRemoveChildren && p._enabled(!1, !1), (p._active = !1)),
        ...
        k = function (a, d, e, f) {
          ...
          for (i = 0; h > i; i++)
            (j = a[i][d]),
              ...
              (n[i] = new g(j, 0, 0, k)),
              e &&
                ((l = a[i + 2][d]), (b[i] = (b[i] || 0) + (k - j) * (k - j)), (c[i] = (c[i] || 0) + (l - k) * (l - k)));
        ...
        p = _gsScope._gsDefine.plugin({
          ...
          init: function (a, b, c) {
            ...
            if ((n = this._autoRotate))
              for (
                this._initialRotations = [], n[0] instanceof Array || (this._autoRotate = n = [n]), f = n.length;
                --f > -1;
                ...
                (d = n[f][2]),
                  (this._initialRotations[f] =
                    (this._func[d] ? this._func[d].call(this._target) : this._target[d]) || 0),
                  this._overwriteProps.push(d);
              }
        ...
        var k,
          ...
          U = (function () {
            ...
            return (
              ...
              (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(T) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(T)) &&
          ...
          ba = (S.convertToPixels = function (a, c, d, e, f) {
            ...
            if ((n && (d = -d), o && (d *= 100), 'lineHeight' !== c || e))
              if ('%' === e && -1 !== c.indexOf('border')) h = (d / 100) * (k ? a.clientWidth : a.clientHeight);
                ...
                if (
                  ((m.cssText = 'border:0 solid red;position:' + aa(a, 'position') + ';line-height:0;'),
          ...
          na = function (a, b, c) {
            return (
              (a = 0 > a ? a + 1 : a > 1 ? a - 1 : a),
              (255 * (1 > 6 * a ? b + (c - b) * a * 6 : 0.5 > a ? c : 2 > 3 * a ? b + (c - b) * (2 / 3 - a) * 6 : b) +
                0.5) |
                0
            );
          },
            ...
            if (a)
              if ('number' == typeof a) c = [a >> 16, (a >> 8) & 255, 255 & a];
                ...
                if ((',' === a.charAt(a.length - 1) && (a = a.substr(0, a.length - 1)), ma[a])) c = ma[a];
                  ...
                  4 === a.length &&
                    ((d = a.charAt(1)), (e = a.charAt(2)), (f = a.charAt(3)), (a = '#' + d + d + e + e + f + f)),
        ...
        (qa = new RegExp(qa + ')', 'gi')),
          (g.colorStringFilter = function (a) {
            var b,
              c = a[0] + ' ' + a[1];
            qa.test(c) &&
              ((b = -1 !== c.indexOf('hsl(') || -1 !== c.indexOf('hsla(')), (a[0] = pa(a[0], b)), (a[1] = pa(a[1], b))),
              (qa.lastIndex = 0);
          }),
                  ...
                  y && !U && 0 === u[3]
                    ...
                    : (U || (y = !1),
                      C
                        ? h
                            .appendXtra(
                              z.substr(0, z.indexOf('hsl')) + (y ? 'hsla(' : 'hsl('),
                              p[0],
                              ja(u[0], p[0]),
                              ',',
                              !1,
                        ...
                        : h
                            .appendXtra(
                              z.substr(0, z.indexOf('rgb')) + (y ? 'rgba(' : 'rgb('),
                              p[0],
                              u[0] - p[0],
                              ',',
                              Math.round,
                ...
                ? (g.l++,
                  ...
                  h > 0
                    ? ((g.data['xn' + h] = b + c),
                      ...
                      (g['xn' + h] = b),
                      g.plugin ||
                        ((g.xfirst = new ua(g, 'xn' + h, b, c, g.xfirst || g, 0, g.n, e, g.pr)), (g.xfirst.xs0 = 0)),
                      g)
        ...
        var Ba,
              ...
              (!d || (h = d.split(' ')).length < 2) &&
                ...
                0 === n.x &&
                  ...
                  (n = {
                    x:
                      parseFloat(
                        a.hasAttribute('x') ? a.getAttribute('x') : a.hasAttribute('cx') ? a.getAttribute('cx') : 0
                      ) || 0,
                    y:
                      parseFloat(
                        a.hasAttribute('y') ? a.getAttribute('y') : a.hasAttribute('cy') ? a.getAttribute('cy') : 0
                      ) || 0,
                    width: 0,
                    height: 0,
                  }),
          ...
          Sa = (S.getTransform = function (a, c, d, e) {
            ...
            if (
              ((m.svg = !(!a.getCTM || !Pa(a))),
              m.svg &&
                (Ma(a, aa(a, Fa, c, !1, '50% 50%') + '', m, a.getAttribute('data-svg-origin')),
              ...
              if (16 === f.length) {
                var s,
                  ...
                  N = Math.atan2(D, H);
                m.zOrigin &&
                  ((K = -m.zOrigin), (I = F * K - f[12]), (J = G * K - f[13]), (K = H * K + m.zOrigin - f[14])),
                  (m.rotationX = N * L),
                  N &&
                    ((v = Math.cos(-N)),
                    (w = Math.sin(-N)),
                  ...
                  (C /= m.scaleY),
                  Math.abs(N) > o
                    ? ((m.skewX = N * L), (B = 0), 'simple' !== m.skewType && (m.scaleY *= 1 / Math.cos(N)))
                    : (m.skewX = 0),
            ...
            if (m) {
              ...
              if (
                ...
                s
                  ? ((n = q / 2),
                    (o = r / 2),
                    (t += ', Dx=' + (n - (n * h + o * i) + u) + ', Dy=' + (o - (n * j + o * k) + v) + ')'))
                ...
                for (
                  ...
                  (z = ga[xa]),
                    ...
                    (A =
                      c !== d[z] ? (2 > xa ? -d.ieOffsetX : -d.ieOffsetY) : 2 > xa ? n - d.ieOffsetX : o - d.ieOffsetY),
            ...
            S.setTransformRatio =
              function (a) {
                ...
                (k = 1),
                  ...
                  C || D || 1 !== G
                    ? ((u +=
                        v + (q > j && j > -q ? w : j) + v + (q > m && m > -q ? w : m) + v + (q > e && e > -q ? w : e)),
                      (u +=
                        v +
                        (q > h && h > -q ? w : h) +
                        v +
                ...
                if (
                  ...
                  (l = Q.style),
                    ...
                    C.svg &&
                      ...
                      (p || s) &&
                        ((t = Ra(Q, !0)), (k.x -= p - (p * t[0] + s * t[2])), (k.y -= s - (p * t[1] + s * t[3])))),
                  ...
                  'string' == typeof z.x && -1 !== z.x.indexOf('%') && ((k.x = 0), (k.xPercent = ka(z.x, C.xPercent))),
                    ...
                    (k.rotation = la(
                      'rotation' in z ? z.rotation : 'shortRotation' in z ? z.shortRotation + '_short' : C.rotation,
                      C.rotation,
                      'rotation',
                      A
                    )),
            ...
            parser: function (a, b, c, d, f, g) {
              ...
              return (
                ...
                this.parseComplex(
                  a.style,
                  this.format(
                    h + ' ' + aa(a, 'borderTopStyle', e, !1, 'solid') + ' ' + aa(a, 'borderTopColor', e, !1, '#000')
                  ),
                  i.join(' '),
                  f,
                  g
        ...
        (j = g.prototype),
          ...
          (j._onInitTween = function (a, b, h, j) {
            ...
            if (
              (l &&
                '' === A.zIndex &&
                ((n = aa(a, 'zIndex', e)), ('auto' === n || '' === n) && this._addLazySet(A, 'zIndex', 0)),
              'string' == typeof b &&
                ((t = A.cssText),
                (n = da(a, e)),
                (A.cssText = t + ';' + b),
                ...
                z = 3 === this._transformType,
                  Da
                    ? m &&
                      ((l = !0),
                      '' === A.zIndex &&
                        ((w = aa(a, 'zIndex', e)), ('auto' === w || '' === w) && this._addLazySet(A, 'zIndex', 0)),
                      o &&
                        this._addLazySet(
                          A,
              ...
              if (((n = b[g]), (h = i[g]), 'function' != typeof n || (h && h.allowFunc) || (n = n(r, q)), h))
                ...
                (m = aa(a, g, e) + ''),
                  ...
                  'color' === g || 'fill' === g || 'stroke' === g || -1 !== g.indexOf('Color') || (s && A.test(n))
                    ? (s || ((n = oa(n)), (n = (n.length > 3 ? 'rgba(' : 'rgb(') + n.join(',') + ')')),
                    ...
                    : ((j = parseFloat(m)),
                      ...
                      (!j && 0 !== j) || (!l && 0 !== l)
                        ? void 0 !== u[g] && (n || (n + '' != 'NaN' && null != n))
                          ? ((c = new ua(u, g, l || j || 0, 0, c, -1, g, !1, 0, m, n)),
                            (c.xs0 = 'none' !== n || ('display' !== g && -1 === g.indexOf('Style')) ? n : m))
                          : W('invalid ' + g + ' tween value: ' + b[g])
                        : ((c = new ua(u, g, j, l - j, c, 0, g, k !== !1 && ('px' === p || 'zIndex' === g), 0, m, n)),
                          (c.xs0 = p)));
              }
        ...
        for (e in b)
          'useRadians' !== e &&
            ...
            (g = parseFloat(
              'function' != typeof a[e]
                ? a[e]
                : a[e.indexOf('set') || 'function' != typeof a['get' + e.substr(3)] ? e : 'get' + e.substr(3)]()
            )),
            (h = this.finals[e] =
    ...
    _gsScope._gsDefine(
      ...
      function (a) {
        ...
        return (
          ...
          (r.getRatio = function (a) {
            return (
              this._ease && (a = this._ease.getRatio(a)), (this._p3 * Math.exp(this._p1 * a) - this._p3) / this._p2
            );
          }),
          (r.config = c.config =
            function (a, b, d) {
  ...
  (function (a, b) {
    ...
    var v = [0, 0, 1, 1],
      ...
      y = (w.register = function (a, b, c, d) {
        for (
          var e, f, g, h, i = b.split(','), j = i.length, k = (c || 'easeIn,easeOut,easeInOut').split(',');
          --j > -1;
    ...
    var H = u(
        ...
        function (b, c, d) {
          ...
          var e,
            ...
            g,
            h =
              b.jquery || (b.length && b !== a && b[0] && (b[0] === a || (b[0].nodeType && b[0].style && !b.nodeType))),
                  ...
                  ? 'string' != typeof f
                    ? f.length && f !== a && f[0] && (f[0] === a || (f[0].nodeType && f[0].style && !f.nodeType))
                      ...
                      : ((this._siblings[e] = aa(f, this, !1)),
                        1 === i && this._siblings[e].length > 1 && ca(f, this, null, 1, this._siblings[e]))
    ...
    var aa = function (a, b, c) {
        var d,
          ...
          f = a._gsTweenID;
        if (
          (U[f || (a._gsTweenID = f = 't' + V++)] || (U[f] = { target: a, tweens: [] }),
          ...
          (h = e[f]) === b ||
            ...
            (h._timeline !== b._timeline
              ...
              : h._startTime <= k &&
                ...
                (((o || !h._initted) && k - h._startTime <= 2 * n) || (l[m++] = h)));
        for (f = m; --f > -1; )
          if (
            ((h = l[f]),
            (i = h._firstPT),
    ...
    (i._init = function () {
      ...
      if (
        ...
        for (f = this._targets.length, a = 0; f > a; a++)
          this._initProps(this._targets[a], (this._propLookup[a] = {}), this._siblings[a], h ? h[a] : null, a) &&
            (b = !0);
        ...
        if (h._time !== i || c) {
          if (!h._initted) {
            ...
            h._time && !d
              ...
              : d && h._ease._calcEnd && (h.ratio = h._ease.getRatio(0 === h._time ? 0 : 1));
          }
          for (
            h._lazy !== !1 && (h._lazy = !1),
